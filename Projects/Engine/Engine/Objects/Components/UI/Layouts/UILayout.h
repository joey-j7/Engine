...
#include "Engine/Objects/Components/UI/UIElement.h"
...
namespace Engine
{
	...
	public:
		...
		// <= 0 equals infinite
		void SetGridCount(uint32_t ColumnCount, uint32_t RowCount);

		// If false, the element will be aligned to the preview element or batch of elements
		void AlignElementsToGrid(bool X, bool Y);
	...
	private:
		...
		// 0 = infinite
		UVector2 m_GridCount = UVector2(1, 0);
		...
		bool m_AlignElementsToGridX = false;
		bool m_AlignElementsToGridY = false;
