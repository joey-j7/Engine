...
#include "Engine/Objects/Components/RenderComponent.h"
...
namespace Engine
{
	...
	public:
		...
		const SkPaint& GetPaint() const { return m_Paint; }
		...
		void SetRenderBounds(const Vector2& Origin, const Vector2& Size);
	...
	protected:
		...
		SkRect RenderBounds = SkRect::MakeXYWH(0.f, 0.f, 0.f, 0.f);
